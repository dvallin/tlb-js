...
import { rectangular, Room, largeRectangular, lShaped } from './rooms'
import { findAll } from '../array-utils'
import { Asset } from '../components/asset'
import { AssetSlot, EntrySlot } from './common'

export class RoomGenerator {
  public constructor(public readonly random: Random) {}

  public generate(doorShape: Rectangle, entryDirection: Direction): Room {
    const room = this.random.pick([rectangular, largeRectangular, lShaped])
