...
export abstract class Drawable {
  ...
  public constructor(public readonly character: string, public readonly diffuse: Color) {
  ...
  public computeColor(ambient: Color): void {
    ...
    this.lights.forEach(diffuseLight => (totalLight = totalLight.add(diffuseLight)))
