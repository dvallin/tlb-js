...
describe('astar', () => {
  ...
  describe('L1 neighbourhood', () => {
    ...
    it('finds a path', () => {
      ...
      expect(path).toEqual({ cost: 4, path: [new Vector(2, 2), new Vector(1, 2), new Vector(0, 2), new Vector(0, 1), new Vector(0, 0)] })
    })
  })
  ...
  describe('best effort mode', () => {
    it('finds a path as far as possible along the optimal path', () => {
      ...
      expect(path).toEqual({ cost: 2, path: [new Vector(0, 2), new Vector(0, 1), new Vector(0, 0)] })
    })
  })
})
