...
import { mockComponent, mockReturnValue, mockQueries, mockImplementation4 } from '../mocks'
...
describe('Fov', () => {
  ...
  beforeEach(() => {
    ...
    queries = mockQueries()
    mockImplementation4(queries.fov, (_a: TlbWorld, _b: number, _c: Vector, callback: (pos: Vector, distance: number) => void) => {
